...
## Overview
This project implements a **complete training-to-inference object detection workflow** using **YOLOv8** to detect trash/waste in **real-world, cluttered outdoor scenes**.  
The goal is to follow **industry-aligned workflow principles** rather than relying on toy or studio datasets.
